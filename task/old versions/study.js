...
jatos.onLoad(function() {
  ...
  let sem_block = {
    timeline: [sem_preload, intro_directions, sem_introduction_trials, study_directions,
  ...
  let phon_block = {
    timeline: [phon_preload, intro_directions, phon_introduction_trials, study_directions,
  ...
  let unrel_block = {
    timeline: [unrel_preload, intro_directions, unrel_introduction_trials, study_directions,
      unrel_training_trials, test_directions, unrel_test_trials],
  };
