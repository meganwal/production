/* 
    ...
    In your 'js' folder, create a subfolder called 'custom_plugins'. Place this file within that subfolder.
...
// Adapted from plugin-audio-button-response. Modified: see line 159.



var jsPsychAudioButtonResponseHcl = (function (jspsych) {
  'use strict';

  const info = {
      name: "audio-button-response-hcl",
      parameters: {
   ...
   */
  class AudioButtonResponseHclPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial, on_load) {
          ...
          const setupTrial = () => {
              ...
              // plugin-audio-button-response-hcl edit: changed <div> to <img> with source set by choice array. Buttons array unused.
              var html = '<div id="jspsych-audio-button-response-btngroup">';
              for (var i = 0; i < trial.choices.length; i++) {
                  var image_button =
                                    '<img src="media/images/headphones_check_lite/%choice%.png" class="jspsych-audio-button-response-button" style="cursor: pointer; display: inline-block; margin:' +
  ...
  AudioButtonResponseHclPlugin.info = info;

  return AudioButtonResponseHclPlugin;
