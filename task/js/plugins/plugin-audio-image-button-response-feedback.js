...
// - Moved "disable_buttons()" so that it always occurs before feedback
// - Added feedback (blue border around target image before trial ends)



var jsPsychAudioImageButtonResponseFeedback = (function (jspsych) {
  'use strict';

  const info = {
      name: "audio-image-button-response-feedback",
      parameters: {
   ...
   */
  class AudioImageButtonResponseFeedbackPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial, on_load) {
          ...
          const end_trial = () => {
              ...
              // MODIFICATION: DISABLE BUTTONS BEFORE FEEDBACK
              disable_buttons();
              ...
              var trial_data = {
                  ...
                  // MODIFICATION: ADD button_html TO TRIAL DATA
                  button_html: trial.button_html,
              };

              // MODIFICATION: SHOW FEEDBACK BY HIGHLIGHTING TARGET IMAGE WITH BLUE BORDER
              ...
              this.jsPsych.pluginAPI.setTimeout(() => {
                  ...
                  clicked_image.classList.replace('selected','unselected')
                  target_image.classList.replace('unselected','correct')
              ...
              this.jsPsych.pluginAPI.setTimeout(() => {
                  ...
                  trial_complete();
              }, 4000); // CHANGE TIME-LENGTH OF FEEDBACK HERE
  ...
  AudioImageButtonResponseFeedbackPlugin.info = info;

  return AudioImageButtonResponseFeedbackPlugin;
