...
// - Added delay before audio
// - Added change in border color, moved enable buttons call



var jsPsychAudioImageButtonResponseStudy = (function (jspsych) {
  'use strict';

  const info = {
      name: "audio-image-button-response-study",
      parameters: {
   ...
   */
  class AudioImageButtonResponseStudyPlugin {
      constructor(jsPsych) {
  ...
  AudioImageButtonResponseStudyPlugin.info = info;

  return AudioImageButtonResponseStudyPlugin;
