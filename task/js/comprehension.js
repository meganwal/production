// JS for COMPREHENSION condition
...
jatos.onLoad(function() {
  ...
  // Comprehension training trials - grid of nine images, each trial plays audio "Click on the..." for one of the nine words, participant clicks on image, followed by feedback (border on correct image)
  let training = {
  ...
  let test_directions = {
    ...
    stimulus: `
              <div class = "instructions_text">
                <p>You will now see all nine pictures and will be told to <b> click on </b> one of the images.</p>
                <p>This time, the correct response will <b> not </b> be displayed.</p>
                <p>Press "Continue" to proceed.</p>
              </div>
              `,
    choices: ['Continue'],
  ...
  let sem_block = {
    timeline: [sem_preload, intro_directions, sem_introduction_trials, comp_directions,
      sem_training_trials, test_directions, sem_test_trials],
  };
  ...
  let phon_block = {
    timeline: [phon_preload, intro_directions, phon_introduction_trials, comp_directions,
      phon_training_trials, test_directions, phon_test_trials],
  };
  ...
  let unrel_block = {
    timeline: [unrel_preload, intro_directions, unrel_introduction_trials,
      comp_directions, unrel_training_trials, test_directions, unrel_test_trials],
  };
  ...
  let timeline = [welcome, loop_mic_check, sem_block, break_directions, phon_block, break_directions, unrel_block];
